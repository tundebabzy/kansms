...
VerifyView, ResendSuccessView, NumberListView, HomePageView, is_file_load)

from messaging.forms import MessageForm, SingleReceipientForm, BulkReceipientForm, FileUploadForm

compose_forms = [MessageForm, SingleReceipientForm, BulkReceipientForm, FileUploadForm]
